...
|--------|-------------|-------------------|
| [A — Install from wheel](#a--install-from-a-release-wheel) | End users; quickest path; no build tools needed | No |
...
## A — Install from a release wheel

Download the wheel from the [latest GitHub release](https://github.com/dremio-professional-services/jupyter-plugin/releases/latest).
This is the quickest way to install the extension—no Node.js, npm, or jlpm needed.
...
pip install /path/to/jupyter_dremio-0.1.18-py3-none-any.whl
```
...
# expected:  jupyter-dremio v0.1.18 enabled OK
...
git clone https://github.com/dremio-professional-services/jupyter-plugin.git
cd jupyter-plugin
...
```
jupyter-dremio v0.1.18 enabled OK
```
