...
Download `jupyter_dremio-0.1.18-py3-none-any.whl` from the [latest release](https://github.com/dremio-professional-services/jupyter-plugin/releases/latest), then run:
